getgenv().values = {}
local library = {}
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/bsritk/Karpcheats/main/Signal.lua"))()
...
local cfglocation = "Karpcheatscfg/"
makefolder("Karpcheatscfg")
...
makefolder("Karpcheatslua")

local allluas = {}

for _,lua in pairs(listfiles("Karpcheatslua")) do
	local luaname = string.gsub(lua, "Karpcheatslua\\", "")
	table.insert(allluas, luaname)
end

RunService.RenderStepped:Wait()

local gui = library:New("Karpcheats.cc")
